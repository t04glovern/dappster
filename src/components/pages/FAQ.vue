<template>
  <div class="ui container">
    ...
    <div class="ui segment raised">
      ...
      <p>Although ÐAppster looks like a regular website, it's not one, it's a Decentralized Applications (ÐApps). Cards are not loaded from our database (we do not host anything) but instead directly loaded from the Ethereum blockchain.
      ...
      <p>
      The other cool stuff is that you can check the logic behind ÐAppster by auditing the Smart Contract. You can have a look at the <a target="_blank" href="https://etherscan.io/address/0xa25e8050f80ee99a17e861cd0931d5d362caa34e">contract on Etherscan</a>
      ...
      <p>
        ...
        Thus, there is no registration nor login form, just install and unlock a wallet on MetaMask and you have now access to every ÐAppster features.
      </p>
      <p>
      ...
      <div class="ui stackable grid">
        <div class="column ten wide">
          ...
          <p>
            ...
            ÐAppster take a 1% cut on this transaction.</i>
          </p>
          <p>
      ...
      <div class="ui stackable grid">
        <div class="column ten wide">
          ...
          <p>
            ...
            total amount should be greater than 0.005 Ξ. <i>Note : ÐAppster take a 1% cut on the lease total amount.</i>
          </p>
          <p>
    ...
    <div class="ui segment raised">
      ...
      <p>
        <a target="_blank" href="http://fluffycat.tech/">FluffyCat</a> is an Open-Source Foundation that aims to raise funds for Animal welfare and charity groups.
      </p>
      ...
      <p>I have other projects on the Ethereum blockchain, the profits made by ÐAppster will help fund them. It will also be used
